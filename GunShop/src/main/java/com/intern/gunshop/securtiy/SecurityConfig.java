//package com.intern.gunshop.securtiy;
//
...
//
//import com.intern.gunshop.filter.CustomAuthenticationFilter;
//import com.intern.gunshop.filter.CustomAuthorizationFilter;
//
...
//		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/user/role/**").hasAnyAuthority("ADMIN");

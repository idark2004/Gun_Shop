...
public interface AmmoMapper {
	...
	// Map request to entity ( use for update )
	...
	public Ammo requestToEntityUpdate(AmmoRequest request, @MappingTarget Ammo ammo);
	
	// Map request to entity ( use for create )
	public Ammo requestToEntityCreate(AmmoRequest request);
}
